...
export const WORKSHOP_TYPES = ['Independent', 'MaintainanceCenter', 'Specialized', 'Mobile'];
...
export const EGYPTIAN_CITIES_BY_GOVERNORATE: { [key: string]: string[] } = {
  ...
  'New Valley': ['Kharga', 'Dakhla', 'Farafra', 'Balat', 'Paris', 'Baris', 'El Qasr'],
  Suez: ['Suez City', 'Ain Sokhna', 'Ataqah', 'Faisal', 'Ganayen', 'Arbaeen'],
  Aswan: [
    'Aswan City',
    'Kom Ombo',
    'Daraw',
  ...
  'Beni Suef': ['Beni Suef City', 'Beba', 'Fashn', 'Ehnasia', 'Somosta', 'Nasser', 'New Beni Suef'],
  'Port Said': [
    'Port Said City',
    'Port Fouad',
    'El Arab',
  ...
  'North Sinai': ['Arish', 'Rafah', 'Sheikh Zuweid', 'Bir al-Abed', 'Nekhel', 'Hasana', 'Rumana'],
  Sohag: [
    'Sohag City',
    'Akhmim',
    'Girga',
